    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('not specified', 'Not Specified'), ('male', 'Male'), ('female', 'Female')], default='not specified', max_length=20, verbose_name='Gender')),
                ('website', models.CharField(blank=True, max_length=80, verbose_name='Website')),
