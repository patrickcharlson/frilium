...
def object_relation_base_factory(prefix=None, prefix_verbose=None,
    ...
    :param prefix_verbose: a verbose name of the prefix, used to generate
            a field column of the content object in the Admin
    :param add_related_name: a boolean value indicating, that a
            related name for the generated content type foreign key should be added.
             This value should be true, if you use more than one
             ObjectRelationBase in your model.
    ...
    prefix_verbose = prefix_verbose or "Related object"
    ...
    ct_verbose_name = f"{prefix_verbose}'s type (model)"
    ...
    content_type = models.ForeignKey(
        ...
        blank=optional,
        null=optional,
        help_text=("Please select the type (model) "
    ...
    object_id = models.CharField(
        ...
        blank=optional,
        null=False,
        help_text="Please enter the ID of the related object.",
        max_length=255,
