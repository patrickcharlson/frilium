...
def index(request):
    ...
    return render(request, 'frilium/topics/private/index.html', {'topics': topics})


@login_required
def add_private_topic(request):
    user = request.user
    ...
    return render(request, 'frilium/topics/private/new_private_topic.html', context)
...
def view_topic(request, slug, topic_id):
    ...
    return render(request, 'frilium/topics/private/view.html', context)
...
def remove_participant(request, pk):
    ...
    if request.user.pk == private_topic.user_id:
        return redirect(reverse("frilium:topics:private:index"))
