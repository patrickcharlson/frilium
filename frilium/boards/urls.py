...
from .views import PostUpdateView, TopicsListView, PostListView, NewPostView, NewTopicView, delete_post, edit_topic, \
    show_post, show_topic, index, \
    BoardCategoryListView, all_topics, topic_category
...
urlpatterns = [
    ...
    path('c/b/<slug:slug>/<int:pk>/', BoardCategoryListView.as_view(), name='cat-list'),
